...
class AppEngineTest {
  ...
  void runWhenFirstAvgIsLessThanSecondAvg() {
    testRunCall(0, 1, "Второй список имеет большее среднее значение");
  }

  @Test
  void runWhenFirstAvgIsGreaterThanSecondAvg() {
    testRunCall(1, 0, "Первый список имеет большее среднее значение");
  }

  @Test
  void runWhenFirstAvgIsEqualToSecondAvg() {
    testRunCall(1, 1, "Средние значения равны");
  }
}